...
def search_view(request):
    ...
    # Always render to 'ecom/product_list.html' with search results
    return render(request, 'ecom/shop.html', {'products': products, 'word': word, 'product_count_in_cart': product_count_in_cart})
...
def product_detail_view(request, product_id):
    ...
    return render(request, 'ecom/product_detail.html', {'product': product, 'sizes': sizes})
from django.http import JsonResponse

def product_filter_view(request):
    category = request.GET.get('category', 'all')
    if category == 'Áo':
        products = models.Product.objects.filter(name__startswith='Áo', gender='Male')
    elif category == 'Quần':
        products = models.Product.objects.filter(name__startswith='Quần', gender='Male')
    else:
        products = models.Product.objects.all()
...
def table_admin(request):
    return render(request,'ecom/admin_table.html')