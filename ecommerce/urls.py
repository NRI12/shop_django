...
urlpatterns = [
    ...
    path('login', LoginView.as_view(template_name='ecom/customerlogin.html'),name='customerlogin'),
    ...
    path('checkout_view', views.cart_view,name='checkout_view'),
    ...
    path('api/product-filter/', views.product_filter_view, name='api-product-filter'),
    path('product_list', views.product_list_view, name='product_list'),
    path('admin_table', views.table_admin, name='admin_table'),
